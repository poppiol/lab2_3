...
public class SimilarityFinderTest {
    ...
    @Test
    public void calculateJacardSimilarityTestCountAllCalling() {
        int[] seq = {1, 2, 3};
        int[] seq2 = {4, 5, 6, 7, 8};
        ...
        Assert.assertThat("should be "+ seq.length, sequenceSearcherDubler.getCounter(), is(equalTo(seq.length)));
    }
